...
################################################################################
{
    'name': 'CRM Dashboard - OSUS Executive',
    'version': '17.0.2.0.0',
    'category': 'Extra Tools',
    'summary': 'Modern Executive CRM Dashboard with Advanced Analytics',
    'description': '''CRM dashboard module brings a multipurpose graphical
     dashboard for CRM module with modern executive styling and making the 
     relationship management better and easier''',
    ...
    'assets': {
        'web.assets_backend': [
            ('prepend', 'crm_dashboard/static/src/css/dashboard_modern.css'),
